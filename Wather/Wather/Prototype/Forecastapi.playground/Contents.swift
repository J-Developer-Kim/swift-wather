...
let apiUrl = "https://api2.sktelecom.com/weather/forecast/3days?version=1&lat=37.498206&lon=127.02761&appKey=l7xx7ce05f934c234429badec719a93a291d"
...
let task = session.dataTask(with: url) { (data, response, error) in
    ...
    do {
        ...
        forecase.result.code
        forecase.result.message
        
        forecase.weather.forecast3days.first?.fcst3hour.sky
        forecase.weather.forecast3days.first?.fcst3hour.temperature
    }
    catch {
        print(error)
    }
